...
struct TwoFactorAuthenticationView: View {
    ...
    func sendVerificationCode() {
        ...
        Auth.auth().settings?.isAppVerificationDisabledForTesting = true // Remove this line in production
        
        let firebaseAuthSettings = Auth.auth().settings
        firebaseAuthSettings?.isAppVerificationDisabledForTesting = true // Remove this line in production
